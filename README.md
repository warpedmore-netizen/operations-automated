...
The proposed [Mobile Knowledge Workbench](product/mobile-knowledge-workbench.md) reframes the founder experience around spoken challenge, retained learning, readable decisions and governed knowledge publication. Its local reading and phone-layout corrections are prepared for review. A Jamie-only Tailscale connection and a Confluence Review Draft route remain separate, unapproved connection and publication decisions.
