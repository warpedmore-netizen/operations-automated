...
>
> **Current proposal:** [v0.8 end-to-end business methodology](methodology/operations-automated-v0.8-proposed.md) expands the existing architecture into a practical route from mandate and journeys through operating-model design, implementation, activation, operation and improvement. It also integrates the remaining Human–AI Collaboration, accountability, manual-work, delivery-collaboration, capability-transfer and plain-language feedback. It is not approved methodology.
>
...
Jamie approved and merged that model through PR #17. The proposed [Methodology Lab and end-to-end reader](product/methodology-lab-pilot.md) uses a separate managed tree beneath Draft in the private Methodology space. The first ten-page publication proved the controlled delivery mechanism but founder review found it too light for practical use. The current depth revision expands the same managed identities to a 20-chapter, approximately 14,050-word proposed v0.8 manual, with approved source maps and an explicit review page. Its stable [Confluence reading root](https://operations-automated.atlassian.net/wiki/spaces/OAM/pages/754271/Operations+Automated+Methodology+Consolidated+Draft+v0.8) remains private Draft. Neither the implementation nor the reader prose is approved as Live methodology.
