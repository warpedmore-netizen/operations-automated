...
Jamie approved and merged that model through PR #17. The proposed [Methodology Lab pilot](product/methodology-lab-pilot.md) implements the first reader path as a separate managed tree beneath Draft in the private Methodology space. Its ten proposed pages use approved source maps and end with a structured review for the first methodology-and-Workbench feedback loop. Draft publication is authorised independently of merge; neither the implementation nor the Lab prose is approved as Live methodology.
