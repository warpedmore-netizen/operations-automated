...
An operation is more than a process diagram. It joins purpose, people, demand, work, decisions, dependencies, risk, information, technology, performance and learning.

Use the operational lenses proportionately. Select the views that could materially change the conclusion, and explain why any consequential lens is outside scope.
...
Once the current system and material connections are visible, use OPERATE to prioritise, redesign, implement and learn.
