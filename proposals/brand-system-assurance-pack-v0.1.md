---
id: OA-PROPOSAL-014
title: Operations Automated Brand System Assurance Pack
status: proposed
version: 0.1
owner: Jamie Peppard
date: 2026-07-25
decision_required: approve, revise or reject the draft brand foundation for internal validation
---

# Operations Automated brand system assurance pack
...
The proposal makes **Connected operations. Human outcomes.** the organising brand thought.

It presents Operations Automated as:
...
The proposed primary working line is:
...
| Area | Effect |
|---|---|
| Approved methodology | No meaning change; the brand expresses existing principles |
...
5. test logo recognition, contrast, reflow, keyboard use, document rendering and time to first useful action; and
6. retain corrections and decide whether v0.2 should be proposed.
...
- a new external connection;
- font purchasing or other spending;
- trade-mark or legal clearance;
- a separate product logo; or
- any change to approved methodology meaning.
