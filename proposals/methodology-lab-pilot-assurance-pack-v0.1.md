...
- **AI recommendation:** Publish the committed proposal to Draft now for reading; review and merge the implementation separately.
- **Assurance position:** Ready for private implementation review. Jamie has authorised AI publication into the controlled Draft area; Live promotion remains unapproved.
...
- **AI inference:** A separate managed root tree beneath the existing Methodology **Draft** page provides enough isolation without adding a space, connection or migration.
...
|---|---|---|
| Confluence delivery | A controlled lifecycle-first mirror and an approved human-publication model | A separate ten-page Methodology Lab beneath Draft implements the first book-style reader pilot |
...
| Human authority | Pass – AI may publish only to Draft; methodology approval, merge, conflict resolution and Live promotion remain with Jamie |
| Deletion and scheduled publication | Pass – both remain disabled |
...
- continued controlled Draft publication from committed source.

The standing Draft authority does not authorise:

- promotion or republication to Live;
...
## Draft and Live authority

Jamie has explicitly authorised AI to publish committed proposed documents into the controlled Confluence Draft structure without another approval touchpoint.

The authority is bounded to Draft. A conflict stops the write, every page remains visibly proposed, and every write retains its Git source and returned Confluence version. Moving, recreating or treating this material as Live requires Jamie's separate explicit approval.
