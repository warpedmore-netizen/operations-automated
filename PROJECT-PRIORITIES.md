...
- **Confluence position:** the private connection, lifecycle-first controlled mirror and human-first publication model are approved, and the first 108-page publication reconciled successfully. The first reader implementation is proposed as an isolated ten-page Methodology Lab using the existing private Methodology space. Document interactions become governed challenge candidates only through the approved manual pilot. Live Lab publication, migration, automatic interaction retrieval, automatic publication, deletion and external use remain unapproved.
...
7. Decide which governance-POC capabilities are useful evidence for the future product before merging any of them.
...
| Confluence human publication | Add a reader-first methodology book and internal handbook, preserve the lifecycle mirror, and route document interactions into governed challenges | Model and three bounded pilots merged through PR #17; ten-page Methodology Lab implementation proposed; current pages unchanged | Review the Lab implementation, then separately confirm its exact live plan and retain the resulting feedback |
