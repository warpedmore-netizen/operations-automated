...
- **Workbench base-completion position:** the proposed 1.8.0 increment exposes unresolved learning, related-signal reviews, visible dispositions and feedback-led release traces in one Methodology Learning area, and requires complete Codex acceptance evidence. The full non-confidential fixture and recovery test pass; real founder use, merge and private release remain separate Decisions.
